...
export const BOOKS = [
  {
    id: 1,
    title: 'মানসিক স্বাস্থ্য ও সুস্থ জীবন',
    titleEn: 'Mental Health & Healthy Life',
  ...
  {
    id: 2,
    title: 'ডায়াবেটিস নিয়ন্ত্রণের সহজ পথ',
    titleEn: 'The Easy Path to Diabetes Control',
    ...
    rating: 4.8,
    reviews: 843,
    cover: 'https://images.unsplash.com/photo-1505751172876-fa1923c5c528?w=400&q=80',
    description:
      "A doctor's plain-language guide to understanding, managing, and reversing Type 2 diabetes through nutrition, lifestyle, and evidence-based medical strategies.",
    fullDesc:
      'Diabetes is reversible for millions — yet most patients are never told this. In this groundbreaking book, Dr. Sohan reveals the nutritional science and lifestyle protocols that have helped hundreds of his patients achieve normal blood sugar without medication dependency.\n\nCovering glycemic index, intermittent fasting, micronutrient deficiencies, exercise timing, and glucose monitoring — this is the book every diabetic patient deserves.',
    previewUrl: 'https://www.w3.org/WAI/WCAG21/Techniques/pdf/pdf-sample.pdf',
  },
  {
    id: 3,
    title: 'হৃদয়ের কথা: একজন চিকিৎসকের স্মৃতিকথা',
    titleEn: "Heart Talks: A Doctor's Memoir",
  ...
  {
    id: 4,
    title: 'শিশুর পুষ্টি ও বিকাশ',
    titleEn: 'Child Nutrition & Development',
    category: 'Pediatrics',
    price: '৳ 319',
    priceUSD: '$4.99',
    pages: 232,
  ...
  {
    id: 5,
    title: 'নিরাময়ের বিজ্ঞান',
    titleEn: 'The Science of Healing',
    category: 'Health & Wellness',
    price: '৳ 389',
    priceUSD: '$5.99',
    pages: 286,
    rating: 4.8,
    reviews: 704,
    cover: 'https://images.unsplash.com/photo-1559757148-5c350d0d3c56?w=400&q=80',
    description:
  ...
  {
    id: 6,
    title: 'প্রেসক্রিপশন ছাড়া সুস্থতা',
    titleEn: 'Wellness Without Prescriptions',
    ...
    rating: 4.6,
    reviews: 456,
    cover: 'https://images.unsplash.com/photo-1519682577862-22b62b24e493?w=400&q=80',
    description:
